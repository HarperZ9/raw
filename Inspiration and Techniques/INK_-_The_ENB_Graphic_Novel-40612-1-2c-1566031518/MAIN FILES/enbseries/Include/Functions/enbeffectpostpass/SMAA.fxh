...
#define SMAA_PRESET      4  // 0 == low, 1 == medium, 2 == high, 3 == ultra, 4 == custom preset, 5 == runtime UI tweak
...
Texture2D SMAA_AreaTex   < string UIName = "SMAA Area Tex";   string ResourceName = "Include/Functions/enbeffectpostpass/SMAA/SMAA_AreaTex.dds";   >;
Texture2D SMAA_SearchTex < string UIName = "SMAA Search Tex"; string ResourceName = "Include/Functions/enbeffectpostpass/SMAA/SMAA_SearchTex.dds"; >;
