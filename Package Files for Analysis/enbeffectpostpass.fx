...
// SkyrimBridge: NOT included in postpass — no SB_ params are used here.
// Including the full 103 float4 header caused constant buffer overflow
// when combined with the ~310 UI params from SHADERGROUP includes.
