...
float Dusk_VDR_MidGrey    < string UIName = "|- Dusk - VDR - Middle Grey In"; string UIWidget = "spinner"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.01; > = 0.0;
...
float  Dawn_CGGammaCorr    < string UIName = "|- Dawn - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Sunrise_CGGammaCorr    < string UIName = "|- Sunrise - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Day_CGGammaCorr    < string UIName = "|- Day - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Sunset_CGGammaCorr    < string UIName = "|- Sunset - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Dusk_CGGammaCorr    < string UIName = "|- Dusk - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Night_CGGammaCorr    < string UIName = "|- Night - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
float  Interior_CGGammaCorr    < string UIName = "|- Interior - Gamma Correction"; string UIWidget = "spinner"; float UIMin = 0.1; float UIMax = 5.0; float UIStep = 0.01; > = 2.0;
...
int UIFilmEmu_LogSpace     < string UIName = ":: Logarithmic color space"; string UIWidget = "spinner"; int UIMin = 0; int UIMax = 4; > = 4;
// 0=Bypass, 1=ACEScg, 2=LogC (Alexa), 3=S-Log3 (Sony), 4=DaVinci Intermediate
int UIFilmEmu_InputGamut   < string UIName = ":: Input Color Gamut"; string UIWidget = "spinner"; int UIMin = 0; int UIMax = 3; > = 3;
// 0=sRGB/Rec.709, 1=Rec.709, 2=DCI-P3, 3=ACEScg
int UIFilmEmu_OutputGamut  < string UIName = ":: Output Color Gamut"; string UIWidget = "spinner"; int UIMin = 0; int UIMax = 2; > = 2;
...
float3 ApplyColorGrading(float3 color)
{
    ...
    {
        // Saturation: multiplicative (1.0 = no change)
        saturation *= SB_GetWP(SB_WP_Saturation, 1.0);

        // Contrast: multiplicative (1.0 = no change)
        contrast *= SB_GetWP(SB_WP_Contrast, 1.0);

        // Color temperature: tint the color balance
        // Negative = cool/blue (rain, snow), Positive = warm/amber (ash, clear)
        float3 weatherTint = SB_GetWeatherColorTint();
        balance *= weatherTint;
    }
