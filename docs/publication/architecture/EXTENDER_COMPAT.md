...
SkyrimBridge v3 includes a complete replacement for [ENB Extender](https://www.nexusmods.com/skyrimspecialedition/mods/104824) (Kitsuune's annotation system). Five integrated systems handle annotation parsing, extern bindings, weather separation, parameter binding, and native GUI panels.
...
Files in `Data/SKSE/Plugins/SkyrimBridge/WeatherSep/{FormID:08X}.ini`:
