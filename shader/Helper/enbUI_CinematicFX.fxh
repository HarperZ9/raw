#ifndef ENBUI_CINEMATICFX_FXH
#define ENBUI_CINEMATICFX_FXH

//----------------------------------------------------------------------------------------------//
//                                                                                              //
//                UI Parameters for Cinematic FX Suite  v2.0                                    //
//                                                                                              //
//  v2.0.1 - IMPROVED with SkyrimBridge v3.0.0 SHADERGROUP 99 integration                      //
//                                                                                              //
...
//  SHADERGROUP 99: SkyrimBridge Cinematic Integration [NEW]                                    //
//                                                                                              //
//----------------------------------------------------------------------------------------------//
...
//========================= SHADERGROUP 99 — SKYRIMBRIDGE CINEMATIC ===========================//
#elif SHADERGROUP == 99

//----------------------------------------------------------------------------------------------//
//                     SKYRIMBRIDGE CINEMATIC FX ENHANCEMENTS                                   //
//----------------------------------------------------------------------------------------------//
// Requires SkyrimBridge SKSE plugin + SkyrimBridge.fxh in Helper/                              //
// Combat-reactive halation, health feedback, spell school coloring, killcam letterbox.        //
//----------------------------------------------------------------------------------------------//

#ifdef SKYRIMBRIDGE_FXH

UI_ELEMENT(SB_CINE_Header,     "    >>>>>>SKYRIMBRIDGE CINEMATIC<<<<<<")

//--- Combat-Reactive Halation ---
int SB_CINE_Spacer0   <string UIName="|--------- Combat-Reactive Halation"; int UIMin=0; int UIMax=0;> = {0};
float UISBCINE_CombatHal       <string UIName="|- SB - Combat Halation Boost";         float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_CombatHalMult   <string UIName="|- SB - Combat Halation Multiplier";    float UIMin= 1.0; float UIMax= 2.5; > = { 1.4};
float UISBCINE_LightningHal    <string UIName="|- SB - Lightning Halation Burst";      float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_SpellHal        <string UIName="|- SB - Spell Casting Halation";        float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};

//--- Health Feedback Halation ---
int SB_CINE_Spacer1   <string UIName="|--------- Health Feedback Halation"; int UIMin=0; int UIMax=0;> = {0};
float UISBCINE_HealthHal       <string UIName="|- SB - Health-Based Red Halation";     float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_HealthThresh    <string UIName="|- SB - Health Threshold";              float UIMin= 0.1; float UIMax= 0.5; > = { 0.3};
float UISBCINE_HealthRedShift  <string UIName="|- SB - Health Red Shift Amount";       float UIMin= 0.0; float UIMax= 1.0; > = { 0.5};

//--- Spell School Halation Color ---
int SB_CINE_Spacer2   <string UIName="|--------- Spell School Coloring"; int UIMin=0; int UIMax=0;> = {0};
float UISBCINE_SpellColor      <string UIName="|- SB - Spell School Halation Color";   float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_SpellColorBlend <string UIName="|- SB - Spell Color Blend Amount";      float UIMin= 0.0; float UIMax= 0.5; > = { 0.25};

//--- Killcam Cinematic Letterbox ---
int SB_CINE_Spacer3   <string UIName="|--------- Killcam Letterbox"; int UIMin=0; int UIMax=0;> = {0};
float UISBCINE_KillcamLBox     <string UIName="|- SB - Auto Killcam Letterbox";        float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_KillcamAspect   <string UIName="|- SB - Killcam Aspect Ratio";          float UIMin= 1.5; float UIMax= 2.5; > = { 2.35};

//--- Gate Weave Scene Awareness ---
int SB_CINE_Spacer4   <string UIName="|--------- Gate Weave Awareness"; int UIMin=0; int UIMax=0;> = {0};
float UISBCINE_WeaveCalm       <string UIName="|- SB - Weave Calm Scene Reduction";    float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBCINE_WeaveCalmMult   <string UIName="|- SB - Calm Scene Multiplier";         float UIMin= 0.3; float UIMax= 1.0; > = { 0.6};
float UISBCINE_WeaveMenu       <string UIName="|- SB - Weave Menu Reduction";          float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
