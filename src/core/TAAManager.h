...
//  entire ENB pipeline.  Each frame a compute shader reads the current
...
//  (ping-pong).
//
//  The history texture is exposed as a PS SRV at t22 so ENB shaders can
//  sample it for their own temporal effects (denoise, ghosting, etc.).
//
//  Execution point:
//    HookedPresent -> DoOverlayWork, BEFORE SRVInjector::ClearAll().
//    At this point ENB's full 9-pass pipeline has finished compositing
//    into the backbuffer (R16G16B16A16F stages 1-6, or R10G10B10A2
//    stages 7+).  We resolve against the backbuffer directly.
//=============================================================================
