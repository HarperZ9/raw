...
//
//  Registered as a PostGeometry pipeline pass in RenderPipeline.
//  Cloud output SRV bound at t27 for shader passes.
//=============================================================================
...
public:
    ...
    static constexpr uint32_t kCloudSRVSlot = 37;  // t37 (moved from t27 to avoid SSR conflict)
