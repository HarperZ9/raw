...
#define fContrast lerp(0.9, 1.1, (BLOOM_AMOUNT * 0.33))
#define ECCInBlack 0.5
#define ECCInWhite lerp(0.85, 1.0, (BLOOM_AMOUNT * 0.33))
#define ECCOutBlack 0.0
#define ECCOutWhite 0.725
#define fSaturation float4(0.5, 0.5, 0.5, 0.5)
//UI_FLOAT(post_mixer_bloomShape, "Shape", 0.0, 10.0, 4.0)
#define post_mixer_bloomShape lerp(3.0, 2.0, (BLOOM_AMOUNT * 0.33))
...
// TECHNIQUES //////////////////////////////////////
    TECHNIQUE_UI(GaussPassMBloom, "SIMPLE BLOOM",
