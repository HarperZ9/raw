...
//
//  The cubemap captures the actual rendered scene (post-lighting)
...
public:
    ...
    static constexpr uint32_t kSRVSlot = 34;  // t34 — dynamic cubemap output (moved from t30 to avoid conflict with SharedGPUResources::kBlueNoiseSlot)
