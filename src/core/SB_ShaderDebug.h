#pragma once
// ═══════════════════════════════════════════════════════════════════════════
//  RAW — Shader Compilation Diagnostics (SB_ShaderDebug)
//
//  Hooks D3DCompile to intercept all game shader compilation.
...
//    5. Errors are written to Data/SKSE/Plugins/RAW_ShaderErrors.log
//
//  Requirements:
//    - d3dcompiler_47.dll must be loadable (ships with Windows 10+)
...
namespace SB::Debug
{
    ...
    struct ShaderError
    {
        ...
        // Context: what the compiler was trying to compile
        std::string     shaderProfile;  // e.g., "ps_5_0", "vs_5_0"
        std::string     entryPoint;     // e.g., "PS_Draw", "VS_Main"
        std::string     sourceHint;     // Inferred source .fx file
    ...
    public:
        ...
        // This captures all shader compilations early in the process.
    ...
    private:
        ...
        // Infer the source .fx file from naming conventions
