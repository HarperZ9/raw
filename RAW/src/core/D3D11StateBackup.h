...
struct D3D11StateBackup
{
    ...
    // Compute Shader — expanded to cover high slots used by effects (t30 blue noise, t31 linear depth)
    static constexpr UINT kMaxCSUAVs = 8;
    static constexpr UINT kMaxCSSRVs = 32;
