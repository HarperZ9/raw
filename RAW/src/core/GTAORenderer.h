...
class GTAORenderer : public RendererBase
{
public:
    ...
    void Shutdown();
    // Settings (IsInitialized, IsEnabled, SetEnabled inherited from RendererBase)
...
private:
    ...
    // m_initialized, m_enabled, m_device, m_context, m_screenW, m_screenH — inherited from RendererBase
