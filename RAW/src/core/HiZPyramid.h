...
//  Exposed as SRV at register(t19) for compute shaders (SSR, SSAO).
//=============================================================================
...
namespace SB
{
    ...
    public:
        ...
        /// Build from a specific DSV (used at PostGeometry with backup DSV).
        void BuildPyramidFromDSV(ID3D11DeviceContext* a_ctx,
    ...
    private:
        ...
        void BuildPyramidInternal(ID3D11DeviceContext* a_ctx);
