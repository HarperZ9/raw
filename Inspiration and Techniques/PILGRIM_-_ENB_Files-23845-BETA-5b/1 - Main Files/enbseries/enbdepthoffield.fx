...
#define iADOF_ShapeChromaMode           1                 //[0 or 1]
//------------------------------------------------------------------
...
#define	fADOF_ShapeWeightCurve		4.0
#define	fADOF_ShapeWeightAmount		0.5
#define	fADOF_ShapeChromaAmount		0.18

#if(iADOF_PostBlurMode == 0)
//#define	fADOF_SmootheningAmount		0.8
#endif
...
float bQuality < string UIName="DOF Quality";  string UIWidget="Spinner";  float UIStep=1.0;  float UIMin=1.0; float UIMax=4.0; > = {2.0};
#define fADOF_RenderResolutionMult (bQuality * 0.25)
#define iADOF_ShapeQuality (bQuality + 3)
#define fADOF_SmootheningAmount ((bQuality * 0.25) - 0.25)

bool	bAutoFocus			<string UIName="Autofocus";> = {true};
float	bAperture  < string UIName="Aperture";  string UIWidget="Spinner";  float UIStep=0.01;  float UIMin=0.00; float UIMax=10.0; > = {2.4};
float	fADOF_ShapeRadius	<string UIName="Blur Amount";string UIWidget="Spinner";float UIStep=0.1;float UIMin=0.1;float UIMax=25.0;> = {7.0};
float	fADOF_BokehCurve	<string UIName="Bokeh Intensity";string UIWidget="Spinner";float UIStep=0.1;float UIMin=0.1;float UIMax=20.0;> = {3.0};
float bRatio <string UIName="Lens Type";string UIWidget="Spinner";float UIStep=1.0;float UIMin=1.0;float UIMax=2.0;> = {2.0};
#define fADOF_ShapeAnamorphRatio ((bRatio - 1) * 0.35) + 0.65

float	DOF_Empty1		< string UIName="1 = Anamorphic";	string UIWidget="Spinner";	float UIStep=0.0;	float UIMin=-0.0;	float UIMax=0.0;	> = {0.0};
float	DOF_Empty2		< string UIName="2 = Hexagonal";	string UIWidget="Spinner";	float UIStep=0.0;	float UIMin=-0.0;	float UIMax=0.0;	> = {0.0};
...
technique11 DOF <string UIName="Cinematic DOF";>
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_DOF()));
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#if(ENABLE_AO_TECHNIQUES != 0)
technique11 DOFAO <string UIName="Cinematic DOF"; string RenderTarget="RenderTargetRGBA32";>
{
        pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_DOF()));
