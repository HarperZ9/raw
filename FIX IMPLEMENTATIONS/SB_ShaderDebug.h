...
//
//  Usage:
//    1. Call SB::Debug::ShaderDebug::Get().Install(device, context) once
//       after D3D11 device creation (in your SKSE plugin init).
//    2. Errors are captured automatically from that point forward.
//    3. The overlay renders every frame via a hooked Present() call.
