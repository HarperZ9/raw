...
Playground uses three INI configuration files located in `Data/SKSE/Plugins/Playground/`.
...
| File | Runtime Path |
|---|---|
| FeedbackConfig.ini | `Data/SKSE/Plugins/Playground/FeedbackConfig.ini` |
| WriteBackConfig.ini | `Data/SKSE/Plugins/Playground/WriteBackConfig.ini` |
| WeatherParams.ini | `Data/SKSE/Plugins/Playground/WeatherParams.ini` |
| Shader cache | `Data/SKSE/Plugins/Playground/ShaderCache/*.dxbc` |
| Weather separation | `Data/SKSE/Plugins/Playground/WeatherSep/{FormID:08X}.ini` |
| SKSE log | `Documents/My Games/Skyrim Special Edition/SKSE/Playground.log` |
| Shader error log | `Data/SKSE/Plugins/Playground_ShaderErrors.log` |
