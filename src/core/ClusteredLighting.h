...
static constexpr uint32_t kLightBufferSRVSlot  = 35;  // t35: StructuredBuffer<LightData> (moved from t20 to avoid GTAO conflict)
static constexpr uint32_t kClusterGridSRVSlot  = 21;  // t21: StructuredBuffer<ClusterInfo>
static constexpr uint32_t kLightIndexSRVSlot   = 36;  // t36: Buffer<uint> light index list (moved from t22 to avoid TAA conflict)
