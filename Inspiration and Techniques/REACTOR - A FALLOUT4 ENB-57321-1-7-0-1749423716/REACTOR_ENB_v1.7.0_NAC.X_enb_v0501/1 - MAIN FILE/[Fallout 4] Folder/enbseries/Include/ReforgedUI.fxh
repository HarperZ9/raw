...
#define UI_LINESPACE(num) \
    UI_MESSAGE(Linespace##num, LINESPACE_##num)
...
// LIST
// ----------------------------------------------------------------------------------------------------------
#define PROTOTYPE__UI_LIST(var, name, minval, maxval, defval, list) \
    int var \
    < \
        string UIName = __FETCH_NAME(name); \
...
#define UI_LIST_MULTI(archetype, var, name, minval, maxval, defval, list) \
    ARCHETYPE__##archetype(LIST, int, SELECT, var, name, minval, maxval, defval, list)

#define UI_LIST(var, name, minval, maxval, defval, list) UI_LIST_MULTI(SINGLE, var, name, minval, maxval, defval, list)
#define UI_LIST_SINGLE(var, name, minval, maxval, defval, list) UI_LIST_MULTI(SINGLE, var, name, minval, maxval, defval, list)
#define UI_LIST_EI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(EI, var, name, minval, maxval, defval, list)
#define UI_LIST_DNI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(DNI, var, name, minval, maxval, defval, list)
#define UI_LIST_DN_I(var, name, minval, maxval, defval, list) UI_LIST_MULTI(DN_I, var, name, minval, maxval, defval, list)
#define UI_LIST_DNE_DNI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(DNE_DNI, var, name, minval, maxval, defval, list)
#define UI_LIST_TODI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(TODI, var, name, minval, maxval, defval, list)
#define UI_LIST_TOD_I(var, name, minval, maxval, defval, list) UI_LIST_MULTI(TOD_I, var, name, minval, maxval, defval, list)
#define UI_LIST_TODE_DNI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(TODE_DNI, var, name, minval, maxval, defval, list)
#define UI_LIST_TODE_TODI(var, name, minval, maxval, defval, list) UI_LIST_MULTI(TODE_TODI, var, name, minval, maxval, defval, list)
...
// ----------------------------------------------------------------------------------------------------------
// LINESPACE COLLECTION (my pride and joy)
// ----------------------------------------------------------------------------------------------------------
#define LINESPACE_1   "| "
#define LINESPACE_2   "|  "
#define LINESPACE_3   "|   "
...
#define LINESPACE_98  "|                                                                                                  "
#define LINESPACE_99  "|                                                                                                   "
#define LINESPACE_100 "|                                                                                                    "
#define LINESPACE_101 "|                                                                                                     "
#define LINESPACE_102 "|                                                                                                      "
#define LINESPACE_103 "|                                                                                                       "
#define LINESPACE_104 "|                                                                                                        "
#define LINESPACE_105 "|                                                                                                         "
#define LINESPACE_106 "|                                                                                                          "
#define LINESPACE_107 "|                                                                                                           "
#define LINESPACE_108 "|                                                                                                            "
#define LINESPACE_109 "|                                                                                                             "
#define LINESPACE_110 "|                                                                                                              "
#define LINESPACE_111 "|                                                                                                               "
#define LINESPACE_112 "|                                                                                                                "
#define LINESPACE_113 "|                                                                                                                 "
#define LINESPACE_114 "|                                                                                                                  "
#define LINESPACE_115 "|                                                                                                                   "
#define LINESPACE_116 "|                                                                                                                    "
#define LINESPACE_117 "|                                                                                                                     "
#define LINESPACE_118 "|                                                                                                                      "
#define LINESPACE_119 "|                                                                                                                       "
#define LINESPACE_120 "|                                                                                                                        "
#define LINESPACE_121 "|                                                                                                                         "
#define LINESPACE_122 "|                                                                                                                          "
#define LINESPACE_123 "|                                                                                                                           "
#define LINESPACE_124 "|                                                                                                                            "
#define LINESPACE_125 "|                                                                                                                             "
#define LINESPACE_126 "|                                                                                                                              "
#define LINESPACE_127 "|                                                                                                                               "
#define LINESPACE_128 "|                                                                                                                                "
