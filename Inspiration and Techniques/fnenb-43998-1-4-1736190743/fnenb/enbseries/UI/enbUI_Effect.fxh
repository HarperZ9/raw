...
float SEPARATE_VAR(UIAGIS_TintMax)		<string UIName=TO_STRING(|- TODIE - Max IS Tint);		float UIStep=0.001; float UIMin=-10.0; float UIMax= 1.0; > = {1.0};
float SEPARATE_VAR(UIAGIS_FadeMax)		<string UIName=TO_STRING(|- TODIE - Max IS Fade);		float UIStep=0.001; float UIMin=-10.0; float UIMax= 1.0; > = {1.0};
...
UI_ELEMENT(HCGHeader,"   >Additional Night Eye Enhnacer by HaeVakSa<")
UI_WHITESPACE(38)
bool ENABLE_NightEyefix <string UIName = "Use the Night eye enhancer";> = {false};   
//UI_WHITESPACE(37)
//bool ENABLE_PreD <string UIName = "Enhancer Precise Trigger";> = {false};   
UI_WHITESPACE(36)
//bool ENABLE_TINTSEPER <string UIName = "Separated Tint values";> = {false};   
//bool ENABLE_NightEyefixEX <string UIName = "Enable Fade Effect";> = {false};   
bool ENABLE_NightEyefixBloom <string UIName = "Disable Bloom Effect";> = {false};   
bool ENABLE_NightEyefixLens <string UIName = "Disable Lens Effect";> = {false};   
UI_SPECIAL_WHITESPACE(31)
bool ENABLE_NightVisionColor <string UIName = "Use the forced color filter. ";> = {false};   
bool ENABLE_NightVisionMono <string UIName = "Use Monochrome filter";> = {false};   
float3   NIGHTCOLOR		<string UIName="Forced Changer Color";				string UIWidget="Color";	 > = {0,0,0};
UI_SPECIAL_WHITESPACE(38)
bool ENABLE_NightVisionVinette <string UIName = "NightVision Vignette";> = {false};   
...
UI_WHITESPACE(42)
bool ENABLE_NightVisionGrain <string UIName = "NightVision Grain";> = {false}; 
...
bool ENABLE_NightTonemapp <string UIName = "Use Night Eye Tonemap";> = {false};   
//bool ENABLE_NightTonemappTES <string UIName = "Use Might Eye TEST VA";> = {false};   
#endif //NOTFIRSTTIME

float SEPARATE_VAR(UIAGIS_TintMaxNight)		<string UIName=TO_STRING(|- TODIE - NightEye Tint);		float UIStep=0.001; float UIMin=-10.0; float UIMax= 1.0; > = {1.0};
float SEPARATE_VAR(UIAGIS_Inter)		<string UIName=TO_STRING(|- TODIE - NightEye Vanilla Enhance);		float UIStep=0.01; float UIMin=-10.0; float UIMax= 10.0; > = {0.0};
float SEPARATE_VAR(UIAGIS_Bright)		<string UIName=TO_STRING(|- TODIE - NightEye Bright);		float UIStep=0.01; float UIMin=-10.0; float UIMax= 10.0; > = {1.0};
float SEPARATE_VAR(UIAGIS_Contrast)		<string UIName=TO_STRING(|- TODIE - NightEye Contrast);		float UIStep=0.01; float UIMin=-10.0; float UIMax= 10.0; > = {1.0};
float SEPARATE_VAR(UIAGIS_Saturation)		<string UIName=TO_STRING(|- TODIE - NightEye Saturation);		float UIStep=0.01; float UIMin=-10.0; float UIMax= 10.0; > = {1.0};
