...
float  UI_VigWidth   			<string UIGroup = "Vignette"; string UIName="|- Width";					float UIMin=0.00; float UIMax=1.0;  > = {0.0};
float  UI_VigHeight   			<string UIGroup = "Vignette"; string UIName="|- Height";					float UIMin=0.00; float UIMax=1.0;  > = {0.0};
...
//----------------------------------------------------------------------------------------------//
//                     SKYRIMBRIDGE POSTPASS ENHANCEMENTS                                       //
//----------------------------------------------------------------------------------------------//
// Requires SkyrimBridge SKSE plugin + SkyrimBridge.fxh in Helper/                              //
// Menu passthrough, IMOD-aware grading, cinematic-aware grading.                               //
//----------------------------------------------------------------------------------------------//

#ifdef SKYRIMBRIDGE_FXH

UI_ELEMENT(SB_PP_Header,       "    >>>>>>SKYRIMBRIDGE POSTPASS<<<<<<")

//--- Menu/UI Bypass ---
int SB_PP_Spacer0   <string UIName="|--------- Menu & UI Bypass"; int UIMin=0; int UIMax=0;> = {0};
float UISBPP_MenuBypass       <string UIName="|- SB - Reduce FX In Menus";         float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBPP_MenuSharpReduce  <string UIName="|- SB - Menu Sharpen Reduction";      float UIMin= 0.0; float UIMax= 1.0; > = { 0.8};
float UISBPP_MenuGrainReduce  <string UIName="|- SB - Menu Grain Reduction";        float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};

//--- IMOD/Cinematic Awareness ---
int SB_PP_Spacer1   <string UIName="|--------- IMOD & Cinematic Awareness"; int UIMin=0; int UIMax=0;> = {0};
float UISBPP_IMODAware        <string UIName="|- SB - IMOD-Aware Grading";          float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBPP_IMODBackoff      <string UIName="|- SB - IMOD Grading Backoff";        float UIMin= 0.0; float UIMax= 1.0; > = { 0.5};
float UISBPP_CineAware        <string UIName="|- SB - Cinematic-Aware Grading";     float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBPP_CineBackoff      <string UIName="|- SB - Cinematic Grading Backoff";   float UIMin= 0.0; float UIMax= 1.0; > = { 0.4};

//--- State FX ---
int SB_PP_Spacer2   <string UIName="|--------- State FX"; int UIMin=0; int UIMax=0;> = {0};
float UISBPP_DrunkBlur        <string UIName="|- SB - Auto Drunk Radial Blur";      float UIMin= 0.0; float UIMax= 1.0; > = { 1.0};
float UISBPP_DrunkStrength    <string UIName="|- SB - Drunk Blur Strength";          float UIMin= 0.1; float UIMax= 1.0; > = { 0.4};
